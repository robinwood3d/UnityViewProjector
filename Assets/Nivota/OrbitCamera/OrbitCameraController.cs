...
public class OrbitCameraController : MonoBehaviour
{
    ...
    /// 全屏渐变核心函数
    /// </summary>
    /// <param name="fromAlpha">起始透明度 (0-1)</param>
    /// <param name="toAlpha">目标透明度 (0-1)</param>
    /// <param name="duration">过渡耗时</param>
    /// <param name="color">覆盖颜色</param>
    /// <param name="holdWhenFinished">完成后是否保持当前状态</param>
    public void StartCameraFade(float fromAlpha, float toAlpha, float duration, Color color, bool holdWhenFinished)
    {
        // 1. 只有主相机才允许执行，避免多相机冲突
